...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('resources/assets/css/') }}/components.min.css" />
    <link rel="stylesheet" href="{{ asset('resources/assets/css/') }}/quickadmin-layout.min.css" />
    <link rel="stylesheet" href="{{ asset('resources/assets/css/') }}/quickadmin-theme-default.min.css" />
